...
class Store extends \Magento\Framework\Model\AbstractModel
{
     ...
     */
    protected $_storelocatorHelperUrl;
    ...
    public function __construct(
        ...
        \Magestore\Storelocator\Helper\Url $storelocatorHelperUrl,
    ...
    )
    {
        ...
        $this->_storelocatorHelperUrl = $storelocatorHelperUrl;
    ...
    public function import()
    {
        ...
        $storeName = $this->_storelocatorHelperUrl->characterSpecial($storeName);
    ...
    public function updateUrlKey($rewriteRequestPath = '') {
        ...
        $urlrewrite->setData('request_path','storelocator/'. $url_key.$url_suffix);
        $urlrewrite->setData('target_path', 'storelocator/index/index/viewstore/' . $id);
