...
class ProductExtension extends \Magento\Framework\Api\AbstractSimpleObject implements \Magento\Catalog\Api\Data\ProductExtensionInterface
{
    ...
    /**
     * @return \Magento\GiftCard\Api\Data\GiftcardAmountInterface[]|null
     */
    public function getGiftcardAmounts()
    {
        return $this->_get('giftcard_amounts');
    }

    /**
     * @param \Magento\GiftCard\Api\Data\GiftcardAmountInterface[] $giftcardAmounts
     * @return $this
     */
    public function setGiftcardAmounts($giftcardAmounts)
    {
        $this->setData('giftcard_amounts', $giftcardAmounts);
        return $this;
    }
