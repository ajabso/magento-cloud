...
/**
 * Proxy class for @see \Magento\Customer\Model\Visitor
 */
class Proxy extends \Magento\Customer\Model\Visitor implements \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    /**
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Magento\\Customer\\Model\\Visitor', $shared = true)
    {
    ...
    {
        return $this->_getSubject()->setSkipRequestLogging($skipRequestLogging);
    }
    ...
    {
        return $this->_getSubject()->initByRequest($observer);
    }
    ...
    {
        return $this->_getSubject()->saveByRequest($observer);
    }
    ...
    {
        return $this->_getSubject()->isModuleIgnored($observer);
    }
    ...
    {
        return $this->_getSubject()->bindCustomerLogin($observer);
    }
    ...
    {
        return $this->_getSubject()->bindCustomerLogout($observer);
    }
    ...
    {
        return $this->_getSubject()->bindQuoteCreate($observer);
    }
    ...
    {
        return $this->_getSubject()->bindQuoteDestroy($observer);
    }
    ...
    {
        return $this->_getSubject()->getCleanTime();
    }
    ...
    {
        return $this->_getSubject()->getOnlineInterval();
    }
