...
(function () {
	...
	//-- Public class
	app.lazyload = function () {function _class() {_classCallCheck(this, _class);}_createClass(_class, null, [{ key: 'register',
...
(function (global, $, undefined) {
	...
	core.fn = {
		...
		/**
             ...
             */
		createInstantiableObject: function createInstantiableObject() {
     ...
     */
		lang: function lang(dict, _lang) {
			_lang = !!_lang ? _lang : core.env.lang;
			return !!dict[_lang] ? _lang : 'en';
		},
     ...
     */
		deleteVar: function deleteVar(name) {
			_delete(name);
		},
     ...
     */
		plugIntojQuery: function plugIntojQuery(name, methods) {
			var id = 'kafe' + name;
			name = name || 'CORE';
...
(function () {
	...
	_this.jQuery = $;
	var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) {return typeof obj;} : function (obj) {return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;}; /*! JsRender v0.9.87 (Beta): http://jsviews.com/#jsrender */
	...
	(function (factory, global) {
		...
		if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === "object") {// CommonJS e.g. Browserify
			module.exports = $ ?
			factory(global, $) :
	...
	function (global, $) {
		...
		$views = {
			...
			sub: {
				...
				_gm: getMethod,
				_tg: function _tg() {}, // Constructor for tagDef
				_cnvt: convertVal,
				_tag: renderTag,
				_er: error,
				_err: onRenderError,
		...
		function registerStore(storeName, storeSettings) {
			...
			function theStore(name, item, parentTmpl) {
				...
				if (name && (typeof name === "undefined" ? "undefined" : _typeof(name)) === OBJECT && !name.nodeType && !name.markup && !name.getTgt && !(storeName === "viewModel" && name.getters || name.extend)) {
...
(function () {
	...
	local.cache = function () {
		...
		// tmpl
		$.views.helpers({
			konstan: function (_konstan) {function konstan(_x) {return _konstan.apply(this, arguments);}konstan.toString = function () {return _konstan.toString();};return konstan;}(function (key) {return _.get(konstan, key);}),
			translate: function translate(key) {return app.translation[key];} });
...
(function () {
	...
	local.bind = function () {
		...
		__.$document.on(Modernizr.touchevents ? 'touchstart' : 'click', __.action('toggle-content'), function (e) {
...
(function () {
	...
	var toggleHeight = function toggleHeight(element) {
