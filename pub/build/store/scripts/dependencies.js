...
var konstan = {
	...
	"konstan": {
		...
		"path": {
			"root": "/build/store",
			"fonts": "/build/store/fonts",
			"icons": "/build/store/icons",
			"images": "/build/store/images",
			"raw": "/build/store/raw",
			"scripts": "/build/store/scripts",
			"styles": "/build/store/styles" },
...
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) {return typeof obj;} : function (obj) {return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;}; /**
                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                           * Build: `lodash include="compact,intersection,forEach,includes,clone,isDate,isString,get,merge,template,noConflict" --development --output /Users/brenaud/Documents/PHP/boutik-theme-playground/nwayo/.nwayo-cache/scripts/lodash.js`
...
;(function (window, document, undefined) {
  ...
  (function () {
    ...
    {
      hasOwnProp = function hasOwnProp(object, property) {/* yes, this can give false positives/negatives, but most of the time we don't care about those */
	...
	return (/******/function (modules) {// webpackBootstrap
      ...
      */
				...
				return {
					...
					ask: function ask(opt) {return opt === 'loose' ? currentIntent : currentInput;},

					// returns array: all the detected input types
					types: function types() {return inputTypes;} };
...
!function ($) {
  ...
  Toggler = function () {
    /**
                          ...
                          * @param {Object} options - Overrides to the default plugin settings.
                          */
    function Toggler(element, options) {_classCallCheck(this, Toggler);
      this.$element = element;
    ...
    /**
       ...
       * @function
       * @private
       */_createClass(Toggler, [{ key: '_init', value: function _init()
      {
        var input;
